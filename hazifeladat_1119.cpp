...
bool ures(){
    ...
    if(elementNum==0){ // egyenlővé teszzük az elemek számát mivel üres
...
void mindentTorol(){ 
    ...
    if(elementNum!=0||list!= NULL){ // vizsgáljuk, hogy nem egyenlő nullával az elemek széma és a lista sem nulla

        delete[]list; // akkor töröljük 

        elementNum = 0; // egyenlővéteszzük nullával, hogy az üres helyre töltsünk számot
